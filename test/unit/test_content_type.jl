...
@testset "Content-Type Response Tests" begin
    @testset "get_response_content_type helper function" begin
        ...
        @test P2Ext.get_response_content_type(stream1) == "application/grpc+proto"
        ...
        @test P2Ext.get_response_content_type(stream3) == "application/grpc+json"
        ...
        @test P2Ext.get_response_content_type(stream5) == "application/grpc"
    end
